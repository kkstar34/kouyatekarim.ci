    ...
    <ul class="navbar-nav">
                        ...
                        <li>
                            <div class="progress-container progress-primary">
                                ...
                                <ul class="list-unstyled team-info">
                                    ...
                                    <li>
                                        <img src="assets/images/xs/avatar2.png" alt="Avatar">
                                    </li>
                                    <li>
        ...
        <a href="{{ route('logout') }}"
                                       ...
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"  class="mega-menu" title="Logout">
...
<!-- Left Sidebar -->
 <aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{url('/')}}"><img src="{{url('assets/images/logo.svg')}}" width="25" alt="Aero"><span class="m-l-10">Ghost Coder</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <!-- <li>
           ...
           <!--  <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-chart"></i><span>Charts</span></a>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Mes Demos</span></a>
                <ul class="ml-menu">
                    <li><a href="{{route('light')}}" target="_blank">Light</a></li>
                    <li><a href="{{route('sales')}}"  target="_blank">Sales</a></li>
                    <li><a href="{{route('chat')}}"  target="_blank">Chat</a></li>
                </ul>
            </li>
                ...
                <div class="card">
                    <ul class="list-unstyled">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{url('assets/images/xs/avatar2.png')}}" alt="">
                                    <div class="media-body">
