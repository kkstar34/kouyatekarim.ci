                    ...
                    <div class="card">
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/5.jpg" alt="blog image"></a>
                            ...
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                    <div class="blogitem-meta">
                                        ...
                                        <span><i class="zmdi zmdi-comments"></i><a href="{{route('blog-details')}}">Comments(3)</a></span>
                                    </div>
                                ...
                                <h5><a href="{{route('blog-details')}}">The Most Advance Business Plan</a></h5>
                                ...
                                <a href="{{route('blog-details')}}" class="btn btn-info">Read More</a>
                            </div>
                        </div>
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/7.jpg" alt="blog image"></a>
                                <span class="blogitem-date">Monday, December 15, 2018</span>
                            </div>
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                ...
                                <h5><a href="{{route('blog-details')}}">WTCR from 2018: new rules, more cars, more races</a></h5>
                        ...
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/8.jpg" alt="blog image"></a>
                                <span class="blogitem-date">Monday, December 15, 2018</span>
                            </div>
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                    <div class="blogitem-meta">
                                        <span><i class="zmdi zmdi-account"></i>By <a href="javascript:void(0);">Michael</a></span>
                                        <span><i class="zmdi zmdi-comments"></i><a href="{{route('blog-details')}}">Comments(13)</a></span>
                                    </div>
                                    <div class="blogitem-share">
                                        <ul class="list-unstyled mb-0">
                                            <li><a href="javascript:void(0);"><i class="zmdi zmdi-facebook-box"></i></a></li>
                                ...
                                <h5><a href="{{route('blog-details')}}">All photographs are accurate. None of them is the truth</a></h5>
                        ...
                        <div class="blogitem">
                            <div class="blogitem-image">
                                <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/14.jpg" alt="blog image"></a>
                                <span class="blogitem-date">Monday, December 15, 2018</span>
                            </div>
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-unstyled mb-0 widget-recentpost">
                                <li>
                                    <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/1.jpg" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                        <a href="{{route('blog-details')}}">Fundamental analysis services</a>
                                        <span>August 01, 2018</span>
                                    </div>
                                </li>
                                <li>
                                    <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/2.jpg" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                        <a href="{{route('blog-details')}}">Steps to a successful Business</a>
                                        <span>November 01, 2018</span>
                                    </div>
                                </li>
                                <li>
                                    <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/3.jpg" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                        <a href="#{{route('blog-details')}}">Development Progress Conference</a>
                                        <span>December 01, 2018</span>
                                    </div>
                                </li>
                                <li>
                                    <a href="{{route('blog-details')}}"><img src="assets/images/image-gallery/12.jpg" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                        <a href="{{route('blog-details')}}">Steps to a successful Business</a>
